...
var sdr_pb = require('./sdr_pb.js');
goog.object.extend(proto, sdr_pb);
...
proto.protobrain.CorticalSnapshot.toObject = function(includeInstance, msg) {
  var f, obj = {
    ...
    sdr_pb.SparseDistributedRepresentation.toObject, includeInstance)
  };
...
proto.protobrain.CorticalSnapshot.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    ...
    switch (field) {
    case 1:
      var value = new sdr_pb.SparseDistributedRepresentation;
      reader.readMessage(value,sdr_pb.SparseDistributedRepresentation.deserializeBinaryFromReader);
      msg.addSdr(value);
      break;
    default:
      reader.skipField();
...
proto.protobrain.CorticalSnapshot.serializeBinaryToWriter = function(message, writer) {
  ...
  if (f.length > 0) {
    writer.writeRepeatedMessage(
      1,
      f,
      sdr_pb.SparseDistributedRepresentation.serializeBinaryToWriter
    );
  }
};
...
proto.protobrain.CorticalSnapshot.prototype.getSdrList = function() {
  return /** @type{!Array<!proto.protobrain.SparseDistributedRepresentation>} */ (
    jspb.Message.getRepeatedWrapperField(this, sdr_pb.SparseDistributedRepresentation, 1));
};
...
proto.protobrain.SensorSnapshot.toObject = function(includeInstance, msg) {
  var f, obj = {
    value: (f = msg.getValue()) && encoder_pb.SensorValue.toObject(includeInstance, f),
    sdr: (f = msg.getSdr()) && sdr_pb.SparseDistributedRepresentation.toObject(includeInstance, f)
  };
...
proto.protobrain.SensorSnapshot.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    ...
    switch (field) {
    case 1:
      var value = new encoder_pb.SensorValue;
      reader.readMessage(value,encoder_pb.SensorValue.deserializeBinaryFromReader);
      msg.setValue(value);
      break;
    case 2:
      var value = new sdr_pb.SparseDistributedRepresentation;
...
proto.protobrain.SensorSnapshot.serializeBinaryToWriter = function(message, writer) {
  ...
  if (f != null) {
    writer.writeMessage(
      1,
      f,
      encoder_pb.SensorValue.serializeBinaryToWriter
    );
  }
  f = message.getSdr();
  if (f != null) {
 ...
 */
proto.protobrain.SensorSnapshot.prototype.getValue = function() {
  return /** @type{?proto.protobrain.SensorValue} */ (
    jspb.Message.getWrapperField(this, encoder_pb.SensorValue, 1));
};


/** @param {?proto.protobrain.SensorValue|undefined} value */
proto.protobrain.SensorSnapshot.prototype.setValue = function(value) {
  jspb.Message.setWrapperField(this, 1, value);
};
 ...
 * Clears the message field making it undefined.
 */
proto.protobrain.SensorSnapshot.prototype.clearValue = function() {
 ...
 * @return {boolean}
 */
proto.protobrain.SensorSnapshot.prototype.hasValue = function() {
  return jspb.Message.getField(this, 1) != null;
};
...
proto.protobrain.SensorSnapshot.prototype.getSdr = function() {
  return /** @type{?proto.protobrain.SparseDistributedRepresentation} */ (
    jspb.Message.getWrapperField(this, sdr_pb.SparseDistributedRepresentation, 2));
};
