...
def test_null_inputs(num_neurons):
    neurons = neuron.Neurons(num_neurons, computation=None)
...
def test_connect_input(num_neurons, expected_output):
    neurons = neuron.Neurons(num_neurons, computation=None)
    other = neuron.Neurons(num_neurons, computation=None)
...
def test_no_connections():
    layers = [neuron.Neurons(i, computation=None) for i in [10, 10, 10]]
