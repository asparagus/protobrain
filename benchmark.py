...
if __name__ == "__main__":
    ...
    def create_brain(
        architecture, sensor_dim, computation=None, learning=None, random_seed=0
    ):
    ...
    brains = [
        ...
        create_brain(
            [100, 100, 100], 1024, std_comp, learning.HebbianLearning(0.005, 0.001)
        ),
        create_brain(
            [100, 100, 100], 1024, std_comp, learning.HebbianLearning(0.002, 0.0002)
        ),
        create_brain(
            [100, 100, 100], 1024, std_comp, learning.HebbianLearning(0.001, 0.0001)
        ),
    ]
